...
RED = pygame.image.load('selectscreen.jpg')
...
class Character(Thing):
    ...
    def update(self, up, left, right, platforms):
        ...
        if not self.onGround:
            ...
            if self.yspeed > 100: self.yspeed = 100000
...
def Startscreen(screen):
    #loads all images
    #background_image = pygame.image.load("Bckgrnd0.png").convert()
    background_image = pygame.image.load("the lost.png").convert()
...
pygame.display.set_caption("The Lost Ninja")
